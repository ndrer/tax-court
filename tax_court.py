...
X_train5, X_test5, y_train5, y_test5 = train_test_split(processed_features_maj, labels, test_size=0.2, random_state=1, stratify=labels)
cnb = ComplementNB()
cnb.fit(X_train5, y_train5)
y_pred5 = cnb.predict(X_test5)
print(f1_score(y_test5, y_pred5, average='weighted'))
...
predictions = rf.predict(X_test3)
